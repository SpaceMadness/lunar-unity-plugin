        ...
        { 
            get
            {
                if (m_consoleLinkStyle == null)
                {
                    ...
                    m_consoleLinkStyle.normal.textColor = CEditorSkin.GetColor(CColorCode.Link);
                }
        ...
        { 
            get
            {
                if (m_consoleLinkInnactiveStyle == null)
                {
                    ...
                    m_consoleLinkInnactiveStyle.normal.textColor = CEditorSkin.GetColor(CColorCode.LinkInnactive);
                }
        ...
        public static GUIStyle linkTextStyle
        {
            get
            {
                if (m_linkStyle == null)
                {
                    ...
                    m_linkStyle.normal.textColor = CEditorSkin.GetColor(CColorCode.Link);
                }
