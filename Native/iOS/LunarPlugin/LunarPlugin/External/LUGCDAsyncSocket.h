...
@class LUGCDAsyncReadPacket;
@class LUGCDAsyncWritePacket;
@class LUGCDAsyncSocketPreBuffer;

extern NSString *const LUGCDAsyncSocketException;
extern NSString *const LUGCDAsyncSocketErrorDomain;

extern NSString *const LUGCDAsyncSocketQueueName;
extern NSString *const LUGCDAsyncSocketThreadName;

extern NSString *const LUGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const LUGCDAsyncSocketUseCFStreamForTLS;
#endif
#define LUGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define LUGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define LUGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const LUGCDAsyncSocketSSLPeerID;
extern NSString *const LUGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const LUGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const LUGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const LUGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const LUGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const LUGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define LUGCDAsyncSocketLoggingContext 65535


enum LUGCDAsyncSocketError
{
	LUGCDAsyncSocketNoError = 0,           // Never used
	LUGCDAsyncSocketBadConfigError,        // Invalid configuration
	LUGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	LUGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	LUGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	LUGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	LUGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	LUGCDAsyncSocketClosedError,           // The remote peer closed the connection
	LUGCDAsyncSocketOtherError,            // Description provided in userInfo
};
typedef enum LUGCDAsyncSocketError LUGCDAsyncSocketError;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

@interface LUGCDAsyncSocket : NSObject

/**
 * LUGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, LUGCDAsyncSocket will automatically create it's own socket queue.
 ...
 * 
 * For accepting incoming connections, this means LUGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means LUGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, LUGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, LUGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of LUGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a LUGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a LUGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that LUGCDAsyncSocket does NOT copy the data. It simply retains it.
...
/**
 * LUGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(LUGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(LUGCDAsyncSocket *)sock didAcceptNewSocket:(LUGCDAsyncSocket *)newSocket
 * {
...
@protocol LUGCDAsyncSocketDelegate
@optional
...
**/
- (void)socket:(LUGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(LUGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(LUGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(LUGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(LUGCDAsyncSocket *)sock;
...
**/
- (void)socket:(LUGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
